/********************************************************************************
** Form generated from reading UI file 'bodyidentification.ui'
**
...
#ifndef UI_BODYIDENTIFICATION_H
#define UI_BODYIDENTIFICATION_H
...
public:
    ...
    void setupUi(QDialog *bodyidentification)
    {
        if (bodyidentification->objectName().isEmpty())
            bodyidentification->setObjectName(QString::fromUtf8("bodyidentification"));
        bodyidentification->resize(400, 300);
        verticalLayoutWidget = new QWidget(bodyidentification);
        ...
        verticalLayoutWidget_2 = new QWidget(bodyidentification);
        ...
        horizontalLayoutWidget = new QWidget(bodyidentification);
        ...
        retranslateUi(bodyidentification);

        QMetaObject::connectSlotsByName(bodyidentification);
    } // setupUi

    void retranslateUi(QDialog *bodyidentification)
    {
        bodyidentification->setWindowTitle(QCoreApplication::translate("bodyidentification", "Dialog", nullptr));
        modelDir_PB->setText(QCoreApplication::translate("bodyidentification", "Model Dir", nullptr));
        dataDir_PB->setText(QCoreApplication::translate("bodyidentification", "Data Dir", nullptr));
        personName_LB->setText(QCoreApplication::translate("bodyidentification", "Video Input", nullptr));
        personName_LE->setText(QCoreApplication::translate("bodyidentification", "0", nullptr));
        run_PB->setText(QCoreApplication::translate("bodyidentification", "Run", nullptr));
        abort_pb->setText(QCoreApplication::translate("bodyidentification", "Abort", nullptr));
    } // retranslateUi

};

namespace Ui {
    class bodyidentification: public Ui_bodyidentification {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_BODYIDENTIFICATION_H
