...
public:
    ...
    void setupUi(QDialog *bodyidentification)
    {
        if (bodyidentification->objectName().isEmpty())
            bodyidentification->setObjectName(QStringLiteral("bodyidentification"));
    ...
    {
        bodyidentification->setWindowTitle(QApplication::translate("bodyidentification", "Dialog", Q_NULLPTR));
        modelDir_PB->setText(QApplication::translate("bodyidentification", "Model Dir", Q_NULLPTR));
        dataDir_PB->setText(QApplication::translate("bodyidentification", "Data Dir", Q_NULLPTR));
        personName_LB->setText(QApplication::translate("bodyidentification", "Video Input", Q_NULLPTR));
        personName_LE->setText(QApplication::translate("bodyidentification", "0", Q_NULLPTR));
        run_PB->setText(QApplication::translate("bodyidentification", "Run", Q_NULLPTR));
        abort_pb->setText(QApplication::translate("bodyidentification", "Abort", Q_NULLPTR));
    } // retranslateUi
