...
public:
    ...
    void setupUi(QDialog *humandetection)
    {
        if (humandetection->objectName().isEmpty())
            humandetection->setObjectName(QStringLiteral("humandetection"));
    ...
    {
        humandetection->setWindowTitle(QApplication::translate("humandetection", "Dialog", Q_NULLPTR));
        modelDir_PB->setText(QApplication::translate("humandetection", "Model Dir", Q_NULLPTR));
        dataDir_PB->setText(QApplication::translate("humandetection", "Data Dir", Q_NULLPTR));
        personName_LB->setText(QApplication::translate("humandetection", "Video Input", Q_NULLPTR));
        personName_LE->setText(QApplication::translate("humandetection", "0", Q_NULLPTR));
        run_PB->setText(QApplication::translate("humandetection", "Run", Q_NULLPTR));
        abort_pb->setText(QApplication::translate("humandetection", "Abort", Q_NULLPTR));
    } // retranslateUi
