...
public:
    ...
    void setupUi(QDialog *faceidentification)
    {
        if (faceidentification->objectName().isEmpty())
            faceidentification->setObjectName(QStringLiteral("faceidentification"));
    ...
    {
        faceidentification->setWindowTitle(QApplication::translate("faceidentification", "Dialog", Q_NULLPTR));
        modelDir_PB->setText(QApplication::translate("faceidentification", "Model Dir", Q_NULLPTR));
        dataDir_PB->setText(QApplication::translate("faceidentification", "Data Dir", Q_NULLPTR));
        personName_LB->setText(QApplication::translate("faceidentification", "Video Input", Q_NULLPTR));
        personName_LE->setText(QApplication::translate("faceidentification", "0", Q_NULLPTR));
        run_PB->setText(QApplication::translate("faceidentification", "Run", Q_NULLPTR));
        abort_pb->setText(QApplication::translate("faceidentification", "Abort", Q_NULLPTR));
    } // retranslateUi
