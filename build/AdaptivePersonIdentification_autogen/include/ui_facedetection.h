...
public:
    ...
    {
        facedetection->setWindowTitle(QApplication::translate("facedetection", "Dialog", Q_NULLPTR));
        modelDir_PB->setText(QApplication::translate("facedetection", "Model Dir", Q_NULLPTR));
        dataDir_PB->setText(QApplication::translate("facedetection", "Data Dir", Q_NULLPTR));
        personName_LB->setText(QApplication::translate("facedetection", "Video Input", Q_NULLPTR));
        personName_LE->setText(QApplication::translate("facedetection", "0", Q_NULLPTR));
        run_PB->setText(QApplication::translate("facedetection", "Run", Q_NULLPTR));
        abort_pb->setText(QApplication::translate("facedetection", "Abort", Q_NULLPTR));
    } // retranslateUi
