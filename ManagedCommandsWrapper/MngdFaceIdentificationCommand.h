...
#ifndef __MNGDFACEIDENTIFICATIONCMD_H__
#define __MNGDFACEIDENTIFICATIONCMD_H__
...
namespace ManagedCommandsWrapper {
	...
	public ref class MngdFaceIdentificationCommand : IAbstractSkill
	{
	protected:
		ManagedCommandsWrapper::MngdFaceIdentificationCommandExecutorInputData^ m_inputData;
		FaceIdentificationCommandExecutor_Impl* m_executorPImpl;
		...
		static GCHandle gch;
	public:
		MngdFaceIdentificationCommand();
		MngdFaceIdentificationCommand(System::String^ modelDirPath, System::String^ dataDirPath);
		void Initializer(System::String^ modelDirPath, System::String^ dataDirPath) override;
		virtual ~MngdFaceIdentificationCommand();
