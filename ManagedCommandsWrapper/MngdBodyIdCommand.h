...
#ifndef __MNGDBODYIDCMD_H__
#define __MNGDBODYIDCMD_H__
...
namespace ManagedCommandsWrapper {
	...
	public ref class MngdBodyIdCommand : IAbstractSkill
	{
	protected:
		ManagedCommandsWrapper::MngdBodyIdCommandExecutorInputData^ m_inputData;
		BodyIdCommandExecutor_Impl* m_executorPImpl;
	...
	public:
		MngdBodyIdCommand();
		MngdBodyIdCommand(System::String^ modelDirPath, System::String^ dataDirPath);
		void Initializer(System::String^ modelDirPath, System::String^ dataDirPath) override;
		virtual ~MngdBodyIdCommand() override;
