...
#ifndef __MNGDFACEDETECTIONCMD_H__
#define __MNGDFACEDETECTIONCMD_H__
...
namespace ManagedCommandsWrapper {
	...
	public ref class MngdFaceDetectionCommand : IAbstractSkill
	{
	protected:
		ManagedCommandsWrapper::MngdFaceDetectionCommandExecutorInputData^ m_inputData;
		FaceDetectionCommandExecutor_Impl* m_executorPImpl;
		...
		static GCHandle gch;
	public:
		MngdFaceDetectionCommand();
		MngdFaceDetectionCommand(System::String^ modelDirPath, System::String^ dataDirPath);
		void Initializer(System::String^ modelDirPath, System::String^ dataDirPath) override;
		virtual ~MngdFaceDetectionCommand();
