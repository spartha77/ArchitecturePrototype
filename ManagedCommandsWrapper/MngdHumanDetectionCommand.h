...
#ifndef __MNGDHUMANDETECTIONCMD_H__
#define __MNGDHUMANETECTIONCMD_H__
...
namespace ManagedCommandsWrapper {
	...
	public ref class MngdHumanDetectionCommand : IAbstractSkill
	{
	protected:
		ManagedCommandsWrapper::MngdHumanDetectionCommandExecutorInputData^ m_inputData;
		HumanDetectionCommandExecutor_Impl* m_executorPImpl;
		...
		static GCHandle gch;
	public:
		MngdHumanDetectionCommand();
		MngdHumanDetectionCommand(System::String^ modelDirPath, System::String^ dataDirPath);
		void Initializer(System::String^ modelDirPath, System::String^ dataDirPath) override;
		virtual ~MngdHumanDetectionCommand();
